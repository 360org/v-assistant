...
export const translations = {
  vi: {
    ...
    latest: "Mới nhất",
    new_release_found: "Phát hiện bản phát hành mới từ GitHub Releases!",
    checking_for_updates: "Hệ thống sẽ tự động kiểm tra phiên bản mới nhất từ GitHub Releases.",
  ...
  en: {
    ...
    latest: "Latest",
    new_release_found: "New release detected from GitHub Releases!",
    checking_for_updates: "System automatically checks for the latest version on GitHub Releases.",
