  ...
  },
{
    ...
    tagline: "OpenAI GPT — connect directly",
    oauth: false,
    keyUrl: "https://platform.openai.com/api-keys",
    hint: "Sign in to OpenAI, create a key, and paste it here — you connect straight to GPT.",
  },
{
    id: "claude",
    name: "Claude",
    loginLabel: "Continue with Claude",
    tagline: "Anthropic Claude — connect directly",
    oauth: false,
    keyUrl: "https://console.anthropic.com/settings/keys",
    hint: "Sign in to Anthropic, create a key, and paste it here — you connect straight to Claude.",
  },
{
    id: "gemini",
    name: "Gemini",
    loginLabel: "Continue with Gemini",
    tagline: "Google Gemini — connect directly",
    oauth: false,
    keyUrl: "https://aistudio.google.com/apikey",
    hint: "Sign in to Google AI Studio, create a key, and paste it here — you connect straight to Gemini.",
  },
{
    id: "local",
    name: "Local AI",
