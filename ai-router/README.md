...
AI Router is V-Assistant's local provider gateway. It has two responsibilities:
...
billing, analytics UI, or MITM server as V-Assistant product surfaces.
...
treated as ready for a real V-Assistant credential until that bridge and the
